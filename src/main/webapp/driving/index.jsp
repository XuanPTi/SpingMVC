...
<div class="center">
  <h1 style="text-align: center">Information Assigement</h1>
  <div class="info-driver ">
    <table>
      <tr>
        <td>Tên tuyến đường </td>
        <td>Tên tài xế</td>
        <td>Số lượt đi</td>
      </tr>
      <c:forEach var="driving" items="${listDriving}">
        <tr>
          <th>${driving.driver.name}</th>
          <th>${driving.router.name}</th>
          <th>${driving.turnNumber}</th>
        </tr>
      </c:forEach>
    </table>
  ...
  <form:form cssClass="info-driver" action="driving/create" method="get">
